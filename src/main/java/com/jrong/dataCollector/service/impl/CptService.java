...
public class CptService implements ICptService {
    ...
    public String GetCptCurrentData() {
        ...
        String data = currentDataProcess(lines);
    ...
    public String GetCptHistoryData() {
        ...
        String data = historyDataProcess(lines);
        checkRateExistService.CheckRateExist("Cpt History", data);
        return data;
    }

    private static String currentDataProcess(String[] lines){
    ...
    private static String historyDataProcess(String[] lines){
        AtomicReference<String> json = new AtomicReference<>("");
